    ...
    public static ArrayList<Transaction> transactions = new ArrayList<Transaction>() {
        {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                add(new Transaction(LocalDate.of(2019, 8, 20), "Penalty", 999, Type.INDIVIDUALPAYMENT,
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                add(new Transaction(LocalDate.of(2019, 12, 10), "Penalty", 999, Type.INDIVIDUALPAYMENT,
                        "parking ticket", 0, null));
            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
